...
export default function MainNav({ children }: { children: ReactNode }) {
  ...
  // While the user is loading (user === undefined), render skeleton rows so
  // the panel never appears blank; the /api/auth/me round-trip can take a
  // moment on a cold database connection.
  ...
  return (
    <>
      ...
      >
        ...
        {/* User Footer */}
        {loadingUser && (
          <div className="border-t border-gray-200 p-4 shrink-0" aria-hidden="true">
